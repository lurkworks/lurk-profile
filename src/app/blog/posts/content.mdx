...
`const social = [
    ...
    },
    {
      name: "Email",
      icon: "email", 
      link: "mailto:contact@lurkworks.dev",
    },
];`,
    language: "tsx",
    label: "src/app/resources/content.js"
...
`const home = {
    label: "Home",
    title: "Lurk Works's Portfolio",
    description: "Portfolio of a passionate Java & Kotlin developer based in Japan",
    headline: <>Software Developer & Magic Maker</>,
    subline: (
      <>
        I'm Lurk, a software developer passionate about <InlineCode>Java</InlineCode> and <InlineCode>Kotlin</InlineCode>
        <br /> Creating magical products that make life easier through code.
      </>
    ),
};`,
    language: "tsx",
